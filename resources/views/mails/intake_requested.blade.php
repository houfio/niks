  ...
  <body>
    <div class="content">
      ...
      <p>
        ...
        <a href="{{ route('accept_intake', ['id' => $intake->id, 'token' => $unhashedToken, 'accepted' => 1]) }}" class="button">
          {{ __('mails/intake.accept') }}
        </a>
        <a href="{{ route('accept_intake', ['id' => $intake->id, 'token' => $unhashedToken, 'accepted' => 0]) }}" class="button">
