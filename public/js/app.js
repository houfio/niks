...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @popperjs/core */ "./node_modules/@popperjs/core/lib/popper.js");
...
(function () {
    ...
    document.querySelectorAll('[data-tooltip]').forEach(function (source) {
        var target = document.getElementById(source.dataset.tooltip || '');
        if (!target) {
            return;
        }
        var popper;
        showEvents.forEach(function (event) { return source.addEventListener(event, function () {
            target.setAttribute('data-show', '');
            popper = create(source, target);
        }); });
        hideEvents.forEach(function (event) { return source.addEventListener(event, function () {
    ...
    document.querySelectorAll('.flash').forEach(function (element) {
        var hide = function () { return element.classList.add('dismissed'); };
        element.addEventListener('click', hide);
        setTimeout(hide, 5000);
    });
    document.querySelectorAll('[data-href]').forEach(function (element) {
        var navigate = function () { return window.location.href = element.dataset.href || '/'; };
        element.tabIndex = 0;
...
function create(source, target) {
    return core_1.createPopper(source, target, {
        modifiers: [{
                name: 'offset',
                options: {
                    offset: [0, 8]
...
function destroy(popper, target) {
...
__webpack_require__(/*! /Users/lex/Projects/niks/resources/ts/app.ts */"./resources/ts/app.ts");
module.exports = __webpack_require__(/*! /Users/lex/Projects/niks/resources/sass/app.scss */"./resources/sass/app.scss");
